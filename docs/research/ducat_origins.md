# Where the northern ducat standard comes from

**Subject.** The gold standard of **67 pieces per rough Cologne mark at 23⅔
Karat** — the coin the Reich called *Dukat*, Denmark-Norway called *Ungersk
Gylden* and later *Dukat*, and the Netherlands called *dukaat*. This dossier
asks one question: **where do those two numbers come from?** It surveys every
candidate ancestor that could be tested, records which are excluded and on what
grounds, and states plainly what is still unknown.

**Shared, by design.** The German and Danish ducat coinages have separate
dossiers because their *coins*, ordinances and periodisations are separate. Their
*standard* is one thing, so the search for its origin is written once here and
...
makes the German ducat the obvious model for Denmark's 1531 issue and is the most
economical reading of the evidence — but **no source consulted states it**, and
Denmark could equally have taken the standard from the same trade practice
Hamburg did. Treated throughout as a **well-supported hypothesis, not a finding**.

---

## 1. German gold before 1559 — the ordinance standardised existing practice
...
## 2. Why the «Hungarian» coin is not at the Hungarian standard
...
different value of the Buda mark. §3's «the basis is unrecoverable» is
...
is ruled out as the explanation. See §7.2.

---

## 3. How precisely is the Hungarian standard itself known?

§2 leans on «the Hungarian gulden = 3,55 g at 23¾ Karat». That figure is what
...
1. ~~**The Ferdinand figure is computed, not weighed.**~~ — **RESOLVED in
   §2.** It is a mark division, and the mark is Buda: 245,53 / 69 = 3,55841 g,
...
2. **Fineness is not uniform in the catalogue.** Ferdinand I's florins carry
   ...
   **.986** — the northern ducat's fineness, not Hungary's. **The Hungarian
   source in §2 argues against reading this as a Hungarian debasement:** it
...
3. **The dispersion is real for the earlier rulers and vanishes later.**
   ...
   canonical-figure problem `dk_dukat_portugaloeser_fod.md` `dk_dukat_portugaloeser_fod.md` §0.1 raises for the
   Danish 1531 piece.
...
post-1552 «*1 Ducat = 3.5 Thaler*» (§1). Two mints a thousand kilometres
...
69 per Buda mark at 23¾ Karat, held for three centuries (§2). What remains
...
## 4. Were the Dutch trade ducats the model? No — they are the last arrival
...
van Spaans type*» — but nothing before that. Hamburg's ducat of 1497 (§1)
...
(§1). Its fineness is not published, so its fine content cannot be placed;
...
for the German States (§1) and Hungary (§3) could not be run here. The
...
metal content — and not as its ancestor. See §7.4.

---

## 5. England, Spain, France — and the one weight that lands on 67
...
«*in aansluiting met de praktijk in het Duitse Rijk*» (§4) would produce if
the practice being matched were stated in **fine**-mark terms, and it is an
independent second instance of the pattern §2 flagged from the imperial coin
alone. The lead in §7.2 — look for a pre-1559 instrument phrased as *N per fine
...
northern standard remains, on the evidence here, a northern figure. See §7.5.

---

## 6. The Portuguese link is real — but it explains the Portugaløser, not the ducat
...
figure Hungary gives (§2), on the southern side of the 66/67 break. Portugal
...
that figure, which strengthens rather than weakens §2's finding: the north's
...
contemporary Danish ducats (`dk_dukat_portugaloeser_fod.md` §6.1). **The Portugaløser begins as an imitation of
...
are 2 % apart in fine gold (§6), the northern piece is correspondingly lighter,
...
(`dk_dukat_portugaloeser_fod.md` §2, §7.1), so this is a rough-weight trajectory, not a fine-gold one; a
fineness step anywhere along it would change the picture. And «≈35,5 g» for the
português is a literature figure of the same kind §3 cautions about on the
...
2. **Why 67 and not 66 per Cologne mark?** §2 establishes the negative — 66
   ...
   inherited Rhenish practice, or a definition in **fine**-mark form, since 68
   per fine Cologne mark reproduces the coin to 0,09 % and the Dutch standard of
   1586 independently lands on the same 68 (§5). **The fine-mark wording is the
   specific thing to look for** in any pre-1559 German mint ordinance or
   contract.
3. **The Hungarian standard's coins, as against its standard.** 69 per Buda mark
   at 23¾ Karat is documented and held for three centuries; the catalogued
   *pieces* scatter by ±3 % for the earlier rulers, and two carry a fineness the
   literature says Hungary never used. Pohl, *Ungarische Goldgulden des
   Mittelalters (1325-1540)*, would settle it; not consulted.
4. **Hamburg 1497 — the earliest northern ducat, and its fineness.** At 3,46 g it
   computes to 67,59 per rough Cologne mark, already on the northern side of the
   66/67 break, but no fineness is published, so its fine content cannot be
   placed. A Hamburg mint record, or Fr# 1100's own catalogue entry, would fix
   it — and this is the single most valuable missing datum in the dossier.
5. **Is the northern ducat the écu's weight at ducat fineness?** Rough weights
   agree to 0,16 %, fine gold diverges by 2,66 %, which withdraws the reading
   (§5). Left open only as: what, if anything, fixed the northern rough weight at
   3,49 g.
6. **A type-by-type census of Low Countries gold before 1581.** Numista holds it
   under neither «Netherlands» nor «Belgium», so the German-versus-Dutch priority
   rests on lexicon prose. Van Gelder & Hoc, *Les monnaies des Pays-Bas
   bourguignons et espagnols 1434-1713*, would settle it; not consulted.
7. **Which German ducat is actually the earliest.** Hamburg 1497 is the oldest in
   the 89-type sweep, but Lübeck held the gold-striking privilege from 1340 and
...
- `dk_dukat_portugaloeser_fod.md` — the Danish-Norwegian coinage on this
  standard.
- `daler_klippe_1604.md`, `danish_royal_gold_1560_1648.md`,
  `rhinsk_gylden_fod.md` — adjacent Danish gold.

---

*Opened 2026-08-15, by moving §0.1a / 0.1c-g out of the Danish dossier so the
origin question has one home instead of living inside one country's file.*
